CDC.Datamap = function (c, $, w, _) {    
    ...
    */    
    ...
    handleTooltip = function (stateId, mouse) {
        ...
        if( jQuery.inArray( displayValue, specialClassValues ) > -1 ) {
            $tooltipObj.append('<div>'+dataColumnFriendlyName+': ' + displayValue +'</div>');
        }else{
                ...
                if (stateObj['parent'] === undefined) { //Don't show cities and counties in their own row
                    ...
                    if (hasChildren) {
                        $.each(children, function(index,value) {
                            ...
                            if( jQuery.inArray( childDisplayValue, specialClassValues ) > -1 ) {
                                tableHtml += childDisplayValue;
                            }else{
