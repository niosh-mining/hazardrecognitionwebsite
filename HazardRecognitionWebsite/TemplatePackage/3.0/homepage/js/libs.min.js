/*! TemplatePackage 2014-01-23 Build: 3.0.2.4 */
...
*/
function(a,b){function c(){var a=j();a!==k&&(k=a,e.trigger("orientationchange"))}function d(){var b,c=e.width(),d="min-width-",g="max-width-",i=[],j=[],k="px";f.removeClass(d+h.join(k+" "+d)+k+" "+g+h.join(k+" "+g)+k),a.each(h,function(a,b){c>=b&&i.push(d+b+k),b>=c&&j.push(g+b+k)}),i.length&&(b=i.join(" ")),j.length&&(b+=" "+j.join(" ")),f.addClass(b)}var e=a(b),f=a("html"),g=b.document,h=[320,480,768,1024];a.mh={},a.mh.media=function(){var b={},c=a("<div id='jquery-mediatest'>"),d=a("<body>").append(c);return function(e){if(!(e in b)){var g=a("<style type='text/css'>@media "+e+"{#jquery-mediatest{position:absolute;}}</style>");f.prepend(d).prepend(g),b[e]="absolute"===c.css("position"),d.add(g).remove()}return b[e]}}();var i,j,k;a.event.special.orientationchange=i={setup:function(){return"orientation"in b?!1:(k=j(),e.bind("resize",c),void 0)},teardown:function(){return a.support.orientation?!1:(e.unbind("resize",c),void 0)},add:function(a){var b=a.handler;a.handler=function(a){return a.orientation=j(),b.apply(this,arguments)}}},i.orientation=j=function(){var a=g.documentElement;return a&&a.clientWidth/a.clientHeight<1.1?"portrait":"landscape"},a.mh.addResolutionBreakpoints=function(b){"array"===a.type(b)?h=h.concat(b):h.push(b),h.sort(function(a,b){return a-b}),d()},e.bind("orientationchange.htmlclass resize.htmlclass",function(a){a.orientation&&f.removeClass("portrait landscape").addClass(a.orientation),d()}),e.trigger("orientationchange.htmlclass")}(jQuery,this),/*! Hammer.JS - v1.0.5 - 2013-04-07
