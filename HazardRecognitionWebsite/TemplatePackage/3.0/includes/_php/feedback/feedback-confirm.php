...
<!--[if !IE]><!-->     <html class="no-js nav theme-blue" lang="en-us"> <!--<![endif]-->
	<head>
		<meta charset="utf-8" />
		<title>CDC Anonymous Feedback Sent | CDC</title>

		<meta name="description" content="CDC.gov Feedback Confirmation Page" />
	...
	<body>
		<div id="wrapper">
			<header id="header">
				<div class="container">
					<div class="titlebar">
						<h1>CDC Anonymous Feedback Sent</h1>
					</div>
				</div>
			</header>
			<div class="container">
						...
						<div id="body" class="span19">
							<div id="contentArea">
								...
								<div class="email-link-confirmation">
									<div class="row">
										<div class="message">Thank you for helping us improve our site.</div>
									</div>
									<div class="row">
		...
		<!--include virtual="/TemplatePackage/3.0/include/feedback/metricsSettings.html" -->
