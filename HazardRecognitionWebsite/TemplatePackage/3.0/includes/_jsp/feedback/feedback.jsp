...
<!--[if !IE]><!-->     <html class="no-js nav theme-blue" lang="en-us"> <!--<![endif]-->
	...
	<body>
								...
								<div id="feedbackBody">
									<div class="inner">
										...
										<form action="https://www2c.cdc.gov/podcasts/validation.asp" method="get" class="validate form-horizontal" role="form">
											...
											<input name="EmailTemplate" type="hidden" value="https://www.cdc.gov/TemplatePackage/3.0/includes/feedback/feedback-template.txt" /><!-- <input name="EmailTemplate" type="hidden" value="https://www.cdc.gov/TemplatePackage/3.0/includes/feedback/feedback-template.txt" /> -->
											...
											<fieldset>
												...
												<c:import context="/TemplatePackage" url="/3.0/includes/_jsp/captcha-google2.jsp" charEncoding="UTF-8"></c:import>
		...
		<c:import context="/TemplatePackage" url="/3.0/includes/_jsp/feedback/localJs.jsp" charEncoding="UTF-8"></c:import>
		<script>
			$(function() {
