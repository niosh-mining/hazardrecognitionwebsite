<%@ taglib uri="//java.sun.com/jsp/jstl/core" prefix="c" %>	<link rel="stylesheet" href="/TemplatePackage/3.0/css/lib/bootstrap24.css" />
	<link rel="stylesheet" href="/TemplatePackage/3.0/css/app.css?3.2.3.3" />
	<!--[if gt IE 9]><!--><!--<![endif]-->
	<!--[if IE 7]>
	...
	<![endif]-->
	<link rel="stylesheet" media="print" href="/TemplatePackage/3.0/css/print.css?3.2.3.3" />
	...
	<meta property="cdc:template_version" content="3.2.3.3" />
